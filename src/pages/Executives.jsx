...
import { getExecutivePage } from "../api/publicApi";
  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="bg-white flex-1 min-h-screen">
        <div className="max-w-[960px] mx-auto px-6 md:px-10 py-8 md:py-12">
          {loading ? (
            <div>
            ...
            <div className="border border-gray-100 rounded px-6 py-12 text-center">
              <p className="text-gray-500 text-sm">
                임원 소개 콘텐츠가 아직 준비되지 않았습니다.
              </p>
            </div>
          )}
        </div>
